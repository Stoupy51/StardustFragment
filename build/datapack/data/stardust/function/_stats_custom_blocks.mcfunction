...
scoreboard players add #total_vanilla_cobblestone stardust.data 0
...
tellraw @s [{"translate": "stardust.vanilla_minecraft_cobblestone","color":"gray"},{"score":{"name":"#total_vanilla_cobblestone","objective":"stardust.data"},"color":"white"}]
