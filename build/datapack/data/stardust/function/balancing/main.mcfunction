...
#
# @within	stardust:v4.0.14/second_5 [ as @e[tag=stardust.can_balance,scores={energy.storage=20..}] & at @s[tag=!stardust.balanced] ]
#
...
execute if entity @s[tag=stardust.awakened_stardust_solar_panel] run function stardust:balancing/awakened_stardust_solar_panel/main
