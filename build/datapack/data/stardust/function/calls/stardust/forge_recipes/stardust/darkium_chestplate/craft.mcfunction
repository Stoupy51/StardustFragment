...
#> stardust:calls/stardust/forge_recipes/stardust/darkium_chestplate/craft
#
# @within	stardust:calls/stardust/forge_recipes/stardust/darkium_chestplate/timer
#
...
# Kill ingredients
kill @s
kill @n[type=item,nbt={Item:{"components": {"minecraft:custom_data": {"stardust": {"darkium_block": true}}}, "count": 4}},distance=..1]
kill @n[type=item,nbt={Item:{"id": "minecraft:respawn_anchor", "count": 64}},distance=..1]
kill @n[type=item,nbt={Item:{"id": "minecraft:ink_sac", "count": 64}},distance=..1]
kill @n[type=item,nbt={Item:{"id": "minecraft:ink_sac", "count": 32}},distance=..1]
...
kill @n[type=item,nbt={Item:{"components": {"minecraft:custom_data": {"stardust": {"darkium_ingot": true}}}, "count": 12}},distance=..1]
...
execute align xyz run loot spawn ~0.5 ~0.5 ~0.5 loot stardust:i/darkium_chestplate
