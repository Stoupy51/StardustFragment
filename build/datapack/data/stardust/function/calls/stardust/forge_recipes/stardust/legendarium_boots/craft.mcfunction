...
#> stardust:calls/stardust/forge_recipes/stardust/legendarium_boots/craft
#
# @within	stardust:calls/stardust/forge_recipes/stardust/legendarium_boots/timer
#
...
execute align xyz run loot spawn ~0.5 ~0.5 ~0.5 loot stardust:i/legendarium_boots
