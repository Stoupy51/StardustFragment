...
#> stardust:calls/stardust/forge_recipes/stardust/legendarium_chestplate/craft
#
# @within	stardust:calls/stardust/forge_recipes/stardust/legendarium_chestplate/timer
#
...
# Kill ingredients
kill @s
kill @n[type=item,nbt={Item:{"components": {"minecraft:custom_data": {"stardust": {"legendarium_block": true}}}, "count": 4}},distance=..1]
kill @n[type=item,nbt={Item:{"id": "minecraft:wind_charge", "count": 64}},distance=..1]
kill @n[type=item,nbt={Item:{"id": "minecraft:feather", "count": 64}},distance=..1]
kill @n[type=item,nbt={Item:{"id": "minecraft:feather", "count": 32}},distance=..1]
...
kill @n[type=item,nbt={Item:{"components": {"minecraft:custom_data": {"stardust": {"legendarium_ingot": true}}}, "count": 12}},distance=..1]
...
execute align xyz run loot spawn ~0.5 ~0.5 ~0.5 loot stardust:i/legendarium_chestplate
