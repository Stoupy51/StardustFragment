...
#> stardust:calls/stardust/forge_recipes/stardust/legendarium_leggings/timer
#
...
execute if score @s stardust.forge_timer matches 4 run function stardust:calls/stardust/forge_recipes/stardust/legendarium_leggings/craft
