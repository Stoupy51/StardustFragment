...
#> stardust:calls/stardust/forge_recipes/stardust/solarium_chestplate/timer
#
...
execute if score @s stardust.forge_timer matches 1.. run particle minecraft:dust{color:[1,0.5,0],scale:2} ~ ~ ~ 5 5 5 0.1 125

# When timer reaches 4, craft the item
execute if score @s stardust.forge_timer matches 4 run function stardust:calls/stardust/forge_recipes/stardust/solarium_chestplate/craft
