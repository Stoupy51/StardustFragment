...
#> stardust:calls/stardust/forge_recipes/stardust/solarium_pickaxe/craft
#
# @within	stardust:calls/stardust/forge_recipes/stardust/solarium_pickaxe/timer
#
...
execute align xyz run loot spawn ~0.5 ~0.5 ~0.5 loot stardust:i/solarium_pickaxe
