...
#> stardust:calls/stardust/forge_recipes/stardust/solarium_pickaxe/timer
#
...
execute if score @s stardust.forge_timer matches 4 run function stardust:calls/stardust/forge_recipes/stardust/solarium_pickaxe/craft
