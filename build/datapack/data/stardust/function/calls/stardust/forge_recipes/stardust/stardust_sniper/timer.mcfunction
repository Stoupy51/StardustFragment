...
#> stardust:calls/stardust/forge_recipes/stardust/stardust_sniper/timer
#
...
execute if score @s stardust.forge_timer matches 1.. run particle minecraft:dust{color:[0,0,1],scale:2} ~ ~ ~ 5 5 5 0.1 125

# When timer reaches 4, craft the item
execute if score @s stardust.forge_timer matches 4 run function stardust:calls/stardust/forge_recipes/stardust/stardust_sniper/craft
