...
#> stardust:calls/stardust/forge_recipes/stardust/ultimate_sniper/craft
#
# @within	stardust:calls/stardust/forge_recipes/stardust/ultimate_sniper/timer
#
...
kill @n[type=item,nbt={Item:{"components": {"minecraft:custom_data": {"stardust": {"awakened_stardust_sniper": true}}}, "count": 1}},distance=..1]
...
execute align xyz run loot spawn ~0.5 ~0.5 ~0.5 loot stardust:i/ultimate_sniper
