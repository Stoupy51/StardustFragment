...
#> stardust:custom_blocks/awakened_stardust_block/destroy
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:redstone_block"}},distance=..1] run function stardust:custom_blocks/awakened_stardust_block/replace_item
...
scoreboard players remove #total_awakened_stardust_block stardust.data 1
