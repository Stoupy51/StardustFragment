...
#> stardust:custom_blocks/awakened_stardust_solar_panel/destroy
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:daylight_detector"}},distance=..1] run function stardust:custom_blocks/awakened_stardust_solar_panel/replace_item
...
scoreboard players remove #total_awakened_stardust_solar_panel stardust.data 1
