...
# @executed	at @s
#
# @within	stardust:custom_blocks/cobblestone_miner_lv8/place_main [ at @s ]
#
...
# Add a custom name
data merge entity @s {"CustomName": [{"translate":"stardust.cobblestone_miner_lv"}, ".8"]}

# Modify item display entity to match the custom block
item replace entity @s contents with minecraft:furnace[item_model="stardust:cobblestone_miner_lv8"]
