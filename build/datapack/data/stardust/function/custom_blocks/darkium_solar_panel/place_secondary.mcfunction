...
# @executed	at @s
#
# @within	stardust:custom_blocks/darkium_solar_panel/place_main [ at @s ]
#
...
tag @s add stardust.darkium_solar_panel
tag @s add stardust.vanilla.minecraft_daylight_detector

# Add a custom name
data merge entity @s {"CustomName": {"translate": "stardust.darkium_solar_panel"}}

# Modify item display entity to match the custom block
item replace entity @s contents with minecraft:furnace[item_model="stardust:darkium_solar_panel"]
