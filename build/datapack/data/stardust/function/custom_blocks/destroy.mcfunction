...
#
# @within	stardust:v4.0.15/second_5 [ as @e[type=item_display,tag=stardust.custom_block,predicate=!stardust:advanced_check_vanilla_blocks] & at @s ]
#			stardust:v4.0.15/second [ as @e[type=#stardust:custom_blocks,tag=...,predicate=!stardust:advanced_check_vanilla_blocks] & at @s ]
#			stardust:v4.0.15/tick_2 [ as @e[type=item_display,tag=...,predicate=!stardust:check_vanilla_blocks] & at @s ]
...
execute if score #total_vanilla_iron_block stardust.data matches 1.. if entity @s[tag=stardust.vanilla.minecraft_iron_block] unless block ~ ~ ~ minecraft:iron_block run return run function stardust:custom_blocks/_groups/minecraft_iron_block
...
execute if score #total_vanilla_red_nether_bricks stardust.data matches 1.. if entity @s[tag=stardust.vanilla.minecraft_red_nether_bricks] unless block ~ ~ ~ minecraft:red_nether_bricks run return run function stardust:custom_blocks/_groups/minecraft_red_nether_bricks
