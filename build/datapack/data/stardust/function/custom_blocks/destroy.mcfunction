...
execute if score #total_vanilla_moss_carpet stardust.data matches 1.. if entity @s[tag=stardust.vanilla.minecraft_moss_carpet] unless block ~ ~ ~ minecraft:moss_carpet run function stardust:custom_blocks/_groups/minecraft_moss_carpet
...
execute if score #total_vanilla_player_head stardust.data matches 1.. if entity @s[tag=stardust.vanilla.minecraft_player_head] unless block ~ ~ ~ minecraft:player_head run function stardust:custom_blocks/_groups/minecraft_player_head
