...
#
# @within	stardust:v4.0.7/second_5 [ as @e[type=item_display,tag=stardust.custom_block,predicate=!stardust:advanced_check_vanilla_blocks] & at @s ]
#			stardust:v4.0.7/second [ as @e[type=#stardust:custom_blocks,tag=...,predicate=!stardust:advanced_check_vanilla_blocks] & at @s ]
#			stardust:v4.0.7/tick_2 [ as @e[type=item_display,tag=...,predicate=!stardust:check_vanilla_blocks] & at @s ]
