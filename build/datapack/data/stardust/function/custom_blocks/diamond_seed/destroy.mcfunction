...
execute as @n[type=item,nbt={Item:{components:{"minecraft:custom_data":{"stardust":{"item_frame_destroy":true}}}}},distance=..1] run function stardust:custom_blocks/diamond_seed/replace_item
