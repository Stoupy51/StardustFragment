...
#> stardust:custom_blocks/diamond_seed/place_main
#
...
execute if entity @s[type=item_frame] run function stardust:custom_blocks/diamond_seed/get_facing
...
execute as @n[tag=stardust.new] at @s run function stardust:custom_blocks/diamond_seed/place_secondary
