...
#> stardust:custom_blocks/diamond_seed/replace_item
#
# @executed	as @n[type=item,nbt={Item:{id:"minecraft:moss_carpet"}},distance=..1]
#
# @within	stardust:custom_blocks/diamond_seed/destroy [ as @n[type=item,nbt={Item:{id:"minecraft:moss_carpet"}},distance=..1] ]
#
