...
# @executed	at @s
#
# @within	stardust:custom_blocks/double_compressed_cobblestone/place_main [ at @s ]
#
...
item replace entity @s contents with minecraft:furnace[item_model="stardust:double_compressed_cobblestone"]
