...
#
# @within	stardust:custom_blocks/elite_stardust_seed/place_main [ as @n[tag=stardust.new] & at @s ]
#
...
item replace entity @s contents with minecraft:furnace[item_model="stardust:elite_stardust_seed",custom_data={stardust:{item_frame_destroy:true,alt_destroy:"stardust.elite_stardust_seed"}}]
