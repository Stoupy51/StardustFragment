...
#
# @within	stardust:custom_blocks/elite_stardust_seed/destroy [ as @n[type=item,nbt={Item:{id:"minecraft:moss_carpet"}},distance=..1] ]
#
...
function stardust:custom_blocks/elite_stardust_seed/is_fully_grown
