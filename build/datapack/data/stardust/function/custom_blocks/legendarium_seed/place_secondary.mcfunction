...
# @executed	at @s
#
# @within	stardust:custom_blocks/legendarium_seed/place_main [ at @s ]
#
...
item replace entity @s contents with minecraft:furnace[item_model="stardust:legendarium_seed"]
data modify entity @s transformation.scale set value [1.002f,1.002f,1.002f]
data modify entity @s brightness set value {block:15,sky:15}

# Update seed model
scoreboard players add @s stardust.growth_time 0
function stardust:custom_blocks/legendarium_seed/update_seed_model
