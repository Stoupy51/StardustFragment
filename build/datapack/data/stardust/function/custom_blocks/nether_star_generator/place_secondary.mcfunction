...
# @executed	at @s
#
# @within	stardust:custom_blocks/nether_star_generator/place_main [ at @s ]
#
...
# Add a custom name
data merge entity @s {"CustomName": {"translate": "stardust.nether_star_generator"}}
...
scoreboard players set @s stardust.energy_rate 1500
