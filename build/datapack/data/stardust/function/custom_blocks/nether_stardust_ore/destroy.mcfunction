...
#> stardust:custom_blocks/nether_stardust_ore/destroy
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:polished_deepslate"}},distance=..1] run function stardust:custom_blocks/nether_stardust_ore/replace_item
...
scoreboard players remove #total_nether_stardust_ore stardust.data 1
