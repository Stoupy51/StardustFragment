...
execute as @n[type=item,nbt={Item:{id:"minecraft:obsidian"}},distance=..1] run function stardust:custom_blocks/octuple_compressed_cobblestone/replace_item
...
scoreboard players remove #total_octuple_compressed_cobblestone stardust.data 1
