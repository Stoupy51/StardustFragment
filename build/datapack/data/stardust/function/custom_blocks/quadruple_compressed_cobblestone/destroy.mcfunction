...
execute as @n[type=item,nbt={Item:{id:"minecraft:cobbled_deepslate"}},distance=..1] run function stardust:custom_blocks/quadruple_compressed_cobblestone/replace_item
