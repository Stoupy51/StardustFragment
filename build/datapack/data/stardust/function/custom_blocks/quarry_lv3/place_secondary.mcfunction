...
# @executed	at @s
#
# @within	stardust:custom_blocks/quarry_lv3/place_main [ at @s ]
#
...
# Add a custom name
data merge entity @s {"CustomName": {"translate": "stardust.quarry_lv_3","italic": false}}

# Modify item display entity to match the custom block
item replace entity @s contents with minecraft:furnace[item_model="stardust:quarry_lv3"]
data modify entity @s transformation.scale set value [1.002f,1.002f,1.002f]
data modify entity @s brightness set value {block:15,sky:15}

# Energy part
tag @s add energy.receive
scoreboard players set @s stardust.energy_rate 375
...
scoreboard players set @s stardust.quarry_speed 5
