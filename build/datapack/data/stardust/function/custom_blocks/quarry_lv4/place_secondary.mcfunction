...
# @executed	at @s
#
# @within	stardust:custom_blocks/quarry_lv4/place_main [ at @s ]
#
...
tag @s add stardust.quarry_lv4
tag @s add stardust.vanilla.minecraft_barrel

# Add a custom name
data merge entity @s {"CustomName": {"translate": "stardust.quarry_lv_4","italic": false}}

# Modify item display entity to match the custom block
item replace entity @s contents with minecraft:furnace[item_model="stardust:quarry_lv4"]
...
scoreboard players set @s stardust.quarry_speed 8
