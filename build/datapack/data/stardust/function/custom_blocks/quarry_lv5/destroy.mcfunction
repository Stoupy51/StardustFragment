...
execute as @n[type=item,nbt={Item:{id:"minecraft:barrel"}},distance=..1] run function stardust:custom_blocks/quarry_lv5/replace_item
...
scoreboard players remove #total_quarry_lv5 stardust.data 1
