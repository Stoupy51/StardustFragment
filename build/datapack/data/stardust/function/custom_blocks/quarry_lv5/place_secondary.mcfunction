...
# @executed	at @s
#
# @within	stardust:custom_blocks/quarry_lv5/place_main [ at @s ]
#
...
tag @s add stardust.quarry_lv5
tag @s add stardust.vanilla.minecraft_barrel

# Add a custom name
data merge entity @s {"CustomName": {"translate": "stardust.quarry_lv_5","italic": false}}

# Modify item display entity to match the custom block
item replace entity @s contents with minecraft:furnace[item_model="stardust:quarry_lv5"]
data modify entity @s transformation.scale set value [1.002f,1.002f,1.002f]
data modify entity @s brightness set value {block:15,sky:15}

# Energy part
tag @s add energy.receive
scoreboard players set @s stardust.energy_rate 625
...
scoreboard players set @s stardust.quarry_speed 16
