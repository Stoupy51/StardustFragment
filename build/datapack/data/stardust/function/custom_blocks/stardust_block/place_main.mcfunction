...
#> stardust:custom_blocks/stardust_block/place_main
#
...
execute align xyz positioned ~0.5 ~0.5 ~0.5 summon item_display at @s run function stardust:custom_blocks/stardust_block/place_secondary
...
scoreboard players add #total_stardust_block stardust.data 1
