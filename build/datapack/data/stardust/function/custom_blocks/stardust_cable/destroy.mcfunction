...
execute as @n[type=item,nbt={Item:{id:"minecraft:player_head"}},distance=..1] run function stardust:custom_blocks/stardust_cable/replace_item
...
scoreboard players remove #total_stardust_cable stardust.data 1
