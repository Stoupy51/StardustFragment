...
# @executed	at @s
#
# @within	stardust:custom_blocks/stardust_cable/place_main [ at @s ]
#
...
# Add a custom name
data merge entity @s {"CustomName": {"translate": "stardust_cable"}}
...
scoreboard players set @s energy.transfer_rate 480
