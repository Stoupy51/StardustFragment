...
#> stardust:custom_blocks/stardust_core/place_main
#
...
execute align xyz positioned ~0.5 ~0.5 ~0.5 summon item_display at @s run function stardust:custom_blocks/stardust_core/place_secondary
...
scoreboard players add #total_stardust_core stardust.data 1
