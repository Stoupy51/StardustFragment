...
#> stardust:custom_blocks/stardust_furnace_generator/destroy
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:furnace"}},distance=..1] run function stardust:custom_blocks/stardust_furnace_generator/replace_item
...
scoreboard players remove #total_stardust_furnace_generator stardust.data 1
