...
#> stardust:custom_blocks/stardust_portal/destroy
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:lapis_block"}},distance=..1] run function stardust:custom_blocks/stardust_portal/replace_item
...
scoreboard players remove #total_stardust_portal stardust.data 1
