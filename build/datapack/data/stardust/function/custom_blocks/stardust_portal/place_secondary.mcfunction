...
# @executed	at @s
#
# @within	stardust:custom_blocks/stardust_portal/place_main [ at @s ]
#
...
# Add a custom name
data merge entity @s {"CustomName": {"translate": "stardust_portal","italic": false,"color": "blue"}}

# Modify item display entity to match the custom block
item replace entity @s contents with minecraft:furnace[item_model="stardust:stardust_portal"]
