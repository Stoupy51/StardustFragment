...
#> stardust:custom_blocks/ultimate_frame/destroy
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:crying_obsidian"}},distance=..1] run function stardust:custom_blocks/ultimate_frame/replace_item
...
scoreboard players remove #total_ultimate_frame stardust.data 1
