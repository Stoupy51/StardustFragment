...
#> stardust:custom_blocks/ultimate_portal/destroy
#
...
execute as @n[type=item,nbt={Item:{id:"minecraft:crying_obsidian"}},distance=..1] run function stardust:custom_blocks/ultimate_portal/replace_item
...
scoreboard players remove #total_ultimate_portal stardust.data 1
