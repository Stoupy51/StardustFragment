...
#> stardust:mobs/stardust_evoker/convert
#
# @executed	at @s
#
...
data modify entity @s CustomName set value {"translate": "stardust_evoker","color":"aqua"}
...
execute summon item_display run function stardust:mobs/create_model {"entity":"stardust_evoker"}
