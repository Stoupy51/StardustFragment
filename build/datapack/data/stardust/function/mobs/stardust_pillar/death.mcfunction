...
loot give @a[distance=..96] loot stardust:i/stardust_dungeon_key
loot give @a[distance=..96] loot stardust:i/stardust_dungeon_key
loot give @a[distance=..96] loot stardust:i/compacted_stardust_shard
loot give @a[distance=..96] loot stardust:i/compacted_stardust_shard
loot give @a[distance=..96] loot stardust:i/compacted_stardust_shard
loot give @a[distance=..96] loot stardust:i/compacted_stardust_shard
