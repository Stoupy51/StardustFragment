...
execute as @e[type=minecraft:lingering_potion,tag=stardust.check_ultimate_dragon_essence] run function stardust:mobs/ultimate_dragon/essence/check_single_landing
