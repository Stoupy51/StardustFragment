...
#> stardust:mobs/ultimate_dragon/poop/destroy
#
# @executed	as @a[gamemode=!spectator,distance=..2] & at @s
#
# @within	stardust:mobs/ultimate_dragon/poop/check_destroy [ as @a[gamemode=!spectator,distance=..2] & at @s ]
#			stardust:mobs/ultimate_dragon/poop/check_destroy [ as @e[type=arrow,distance=..2] & at @s ]
#
...
execute as @e[tag=stardust.ultimate_boss] at @s run function stardust:mobs/ultimate_dragon/poop/remove_health_percentage
