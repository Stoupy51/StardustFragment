...
#> stardust:mobs/ultimate_dragon/ultimate_poop/check_destroy
#
...
execute as @a[gamemode=!spectator,distance=..2] at @s run function stardust:mobs/ultimate_dragon/ultimate_poop/destroy
execute as @e[type=arrow,distance=..2] at @s run function stardust:mobs/ultimate_dragon/ultimate_poop/destroy
