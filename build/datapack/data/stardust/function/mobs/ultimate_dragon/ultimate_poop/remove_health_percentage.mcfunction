...
#> stardust:mobs/ultimate_dragon/ultimate_poop/remove_health_percentage
#
# @executed	as @e[tag=stardust.dragon] & at @s
#
# @within	stardust:mobs/ultimate_dragon/ultimate_poop/destroy [ as @e[tag=stardust.dragon] & at @s ]
#
