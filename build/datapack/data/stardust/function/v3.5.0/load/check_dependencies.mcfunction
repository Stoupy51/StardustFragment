...
execute if score #dependency_error stardust.data matches 0 if score #simplenergy.major load.status matches 2 if score #simplenergy.minor load.status matches 0 unless score #simplenergy.patch load.status matches 13.. run scoreboard players set #dependency_error stardust.data 1
