...
execute if score #dependency_error stardust.data matches 0 if score $bs.block.major load.status matches 3 unless score $bs.block.minor load.status matches 1.. run scoreboard players set #dependency_error stardust.data 1
execute if score #dependency_error stardust.data matches 0 if score $bs.block.major load.status matches 3 if score $bs.block.minor load.status matches 1 unless score $bs.block.patch load.status matches 1.. run scoreboard players set #dependency_error stardust.data 1
...
execute if score #dependency_error stardust.data matches 0 if score $bs.move.major load.status matches 3 unless score $bs.move.minor load.status matches 1.. run scoreboard players set #dependency_error stardust.data 1
execute if score #dependency_error stardust.data matches 0 if score $bs.move.major load.status matches 3 if score $bs.move.minor load.status matches 1 unless score $bs.move.patch load.status matches 1.. run scoreboard players set #dependency_error stardust.data 1
...
execute if score #dependency_error stardust.data matches 0 if score $bs.raycast.major load.status matches 3 unless score $bs.raycast.minor load.status matches 1.. run scoreboard players set #dependency_error stardust.data 1
execute if score #dependency_error stardust.data matches 0 if score $bs.raycast.major load.status matches 3 if score $bs.raycast.minor load.status matches 1 unless score $bs.raycast.patch load.status matches 1.. run scoreboard players set #dependency_error stardust.data 1
...
execute if score #dependency_error stardust.data matches 0 if score $bs.view.major load.status matches 3 unless score $bs.view.minor load.status matches 1.. run scoreboard players set #dependency_error stardust.data 1
execute if score #dependency_error stardust.data matches 0 if score $bs.view.major load.status matches 3 if score $bs.view.minor load.status matches 1 unless score $bs.view.patch load.status matches 1.. run scoreboard players set #dependency_error stardust.data 1
...
execute if score #dependency_error stardust.data matches 0 if score #simplenergy.major load.status matches 2 if score #simplenergy.minor load.status matches 0 unless score #simplenergy.patch load.status matches 14.. run scoreboard players set #dependency_error stardust.data 1
