...
#> stardust:v4.0.13/load/confirm_load
#
# @within	stardust:v4.0.13/load/valid_dependencies
#
...
# Confirm load
tellraw @a[tag=convention.debug] {"translate":"stardust.loaded_stardust_fragment_v4_0_13","color":"green"}
scoreboard players set #stardust.loaded load.status 1
function stardust:v4.0.13/load/set_items_storage
