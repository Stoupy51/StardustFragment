...
#> stardust:v4.0.14/load/confirm_load
#
# @within	stardust:v4.0.14/load/valid_dependencies
#
...
# Confirm load
tellraw @a[tag=convention.debug] {"translate":"stardust.loaded_stardust_fragment_v4_0_14","color":"green"}
scoreboard players set #stardust.loaded load.status 1
function stardust:v4.0.14/load/set_items_storage
