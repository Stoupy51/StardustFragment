...
#> stardust:v4.0.15/second
#
# @within	stardust:v4.0.15/tick
#
...
execute if score #players_in_dungeon stardust.data matches 1.. in stardust:dungeon run function stardust:dimensions/dungeon/second
