...
#> stardust:v4.0.4/load/confirm_load
#
# @within	stardust:v4.0.4/load/valid_dependencies
#
...
# Confirm load
tellraw @a[tag=convention.debug] {"translate":"stardust.loaded_stardustfragment_v4_0_4","color":"green"}
scoreboard players set #stardust.loaded load.status 1
function stardust:v4.0.4/load/set_items_storage
