...
execute as @e[type=wolf,tag=SF_StoupArmyDrop] run data modify entity @s ArmorItems[0] set from storage stardust:items all.2013000
execute as @e[type=wolf,tag=SF_StoupArmyDrop] run data modify entity @s ArmorItems[1] set from storage stardust:items all.2013000
execute as @e[type=wolf,tag=SF_StoupArmyDrop] run data modify entity @s ArmorItems[2] set from storage stardust:items all.2013000
execute as @e[type=wolf,tag=SF_StoupArmyDrop] run data modify entity @s ArmorItems[3] set from storage stardust:items all.2013000
