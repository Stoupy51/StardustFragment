summon minecraft:arrow ~ ~5 ~ {crit:0,damage:69,NoGravity:1,Tags:["SF_ToThrow","SF_Thrown","SF_AlwaysAiming"]}
summon minecraft:arrow ~5 ~ ~5 {crit:0,damage:69,NoGravity:1,Tags:["SF_ToThrow","SF_Thrown","SF_AlwaysAiming"]}
summon minecraft:arrow ~-5 ~ ~5 {crit:0,damage:69,NoGravity:1,Tags:["SF_ToThrow","SF_Thrown","SF_AlwaysAiming"]}
summon minecraft:arrow ~-5 ~ ~-5 {crit:0,damage:69,NoGravity:1,Tags:["SF_ToThrow","SF_Thrown","SF_AlwaysAiming"]}
summon minecraft:arrow ~-5 ~ ~5 {crit:0,damage:69,NoGravity:1,Tags:["SF_ToThrow","SF_Thrown","SF_AlwaysAiming"]}
