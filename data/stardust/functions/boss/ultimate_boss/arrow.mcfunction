summon minecraft:arrow ~ ~5 ~ {crit:0,damage:14,NoGravity:1,Tags:["StardustFragment_ToThrow","StardustFragment_Thrown","StardustFragment_AlwaysAiming"]}
summon minecraft:arrow ~5 ~ ~5 {crit:0,damage:14,NoGravity:1,Tags:["StardustFragment_ToThrow","StardustFragment_Thrown","StardustFragment_AlwaysAiming"]}
summon minecraft:arrow ~-5 ~ ~5 {crit:0,damage:14,NoGravity:1,Tags:["StardustFragment_ToThrow","StardustFragment_Thrown","StardustFragment_AlwaysAiming"]}
summon minecraft:arrow ~-5 ~ ~-5 {crit:0,damage:14,NoGravity:1,Tags:["StardustFragment_ToThrow","StardustFragment_Thrown","StardustFragment_AlwaysAiming"]}
summon minecraft:arrow ~-5 ~ ~5 {crit:0,damage:14,NoGravity:1,Tags:["StardustFragment_ToThrow","StardustFragment_Thrown","StardustFragment_AlwaysAiming"]}
