summon minecraft:item 0 90 0 {Glowing:1,NoGravity:1b,Item:{id:"minecraft:cobblestone",Count:64b,tag:{SF_Give:1s}}}
data modify entity @e[type=item,nbt={Item:{tag:{SF_Give:1s}}},limit=1] Item set from storage stardust:items 2013012

execute as @a[nbt={Dimension:"stardust:ultimate"}] at @s run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:cobblestone",Count:64b,tag:{SF_Give:1s}},Tags:["SF_GiveConfig"]}
execute as @e[type=item,nbt={Item:{tag:{SF_Give:1s}}}] run data modify entity @s Item set from storage stardust:items 2013003
execute as @e[type=item,tag=SF_GiveConfig] run data modify entity @s Item.Count set value 5
execute as @a[nbt={Dimension:"stardust:ultimate"}] at @s run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:cobblestone",Count:64b,tag:{SF_Give:1s}},Tags:["SF_GiveAwak"]}
execute as @e[type=item,nbt={Item:{tag:{SF_Give:1s}}}] run data modify entity @s Item set from storage stardust:items 2013005
