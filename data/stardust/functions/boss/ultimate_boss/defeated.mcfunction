...
data modify entity @e[type=item,nbt={Item:{tag:{SF_Give:1b}}},limit=1] Item set from storage stardust:items all.2013012
...
execute as @e[type=item,nbt={Item:{tag:{SF_Give:1b}}}] run data modify entity @s Item set from storage stardust:items all.2013003
...
execute as @e[type=item,nbt={Item:{tag:{SF_Give:1b}}}] run data modify entity @s Item set from storage stardust:items all.2013005
