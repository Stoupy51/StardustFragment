...
summon iron_golem ~ ~ ~ {Passengers:[{id:"minecraft:item_display"}],Silent:1b,NoAI:1b,Health:1.0f,Attributes:[{Name:"generic.max_health",Base:1}],DeathLootTable:"none",Team:"stardust.team",Tags:["stardust.new","stardust.ultimate_orb"],ActiveEffects:[{Id:14,Amplifier:0,Duration:2147483647,ShowParticles:0b}]}
