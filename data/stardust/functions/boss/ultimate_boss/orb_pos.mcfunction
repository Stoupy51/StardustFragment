#Define a -/+ value offset randomly with UUID.
	scoreboard players set 40 stardust.data 40
	scoreboard players set 20 stardust.data 20
	...
	scoreboard players operation X stardust.data %= 40 stardust.data
	scoreboard players operation Y stardust.data %= 20 stardust.data
	scoreboard players operation Z stardust.data %= 40 stardust.data
