...
summon minecraft:ender_dragon ~ ~-20 ~ {Health:1024,Attributes:[{Name:"generic.max_health",Base:1024}],Silent:1,Tags:["SF_Dragon"],Team:"SF_Stardust"}
summon minecraft:ender_dragon ~ ~-40 ~ {Health:1024,Attributes:[{Name:"generic.max_health",Base:1024}],Silent:1,Tags:["SF_Dragon"],Team:"SF_Stardust"}
summon minecraft:ender_dragon ~ ~-60 ~ {Health:1024,Attributes:[{Name:"generic.max_health",Base:1024}],Silent:1,Tags:["SF_Dragon"],Team:"SF_Stardust"}
