#Projectiles
	...
	scoreboard players add @e[type=ender_dragon,tag=stardust.dragonDead,limit=1,sort=random] stardust.data 2
...
execute as @e[type=ender_dragon,tag=stardust.dragon,tag=!stardust.ultimate_boss,tag=!stardust.dragonDead] at @s run function stardust:boss/ultimate_boss/check_health
