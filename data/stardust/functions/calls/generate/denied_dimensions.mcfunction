...
execute if score #authorized simplenergy.data matches 1 if predicate stardust:in_dim/dungeon run scoreboard players set #authorized simplenergy.data 0
execute if score #authorized simplenergy.data matches 1 if predicate stardust:in_dim/ultimate run scoreboard players set #authorized simplenergy.data 0
