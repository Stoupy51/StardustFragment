...
#Damaged Stardust Equipments
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_ingot"}}},{Count:1b,id:"minecraft:diamond_helmet"}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/damaged_stardust_helmet
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_ingot"}}},{Count:1b,id:"minecraft:diamond_chestplate"}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/damaged_stardust_chestplate
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_ingot"}}},{Count:1b,id:"minecraft:diamond_leggings"}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/damaged_stardust_leggings
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_ingot"}}},{Count:1b,id:"minecraft:diamond_boots"}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/damaged_stardust_boots
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_ingot"}}},{Count:1b,id:"minecraft:diamond_sword"}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/damaged_stardust_sword
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_ingot"}}},{Count:1b,id:"minecraft:diamond_pickaxe"}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/damaged_stardust_pickaxe
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_ingot"}}},{Count:1b,id:"minecraft:diamond_axe"}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/damaged_stardust_axe

#Reinforced Stardust Equipments
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_essence"}}},{Count:1b,id:"minecraft:leather_helmet",tag:{stardust:{damaged:1b}}}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/reinforced_stardust_helmet
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_essence"}}},{Count:1b,id:"minecraft:leather_chestplate",tag:{stardust:{damaged:1b}}}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/reinforced_stardust_chestplate
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_essence"}}},{Count:1b,id:"minecraft:leather_leggings",tag:{stardust:{damaged:1b}}}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/reinforced_stardust_leggings
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_essence"}}},{Count:1b,id:"minecraft:leather_boots",tag:{stardust:{damaged:1b}}}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/reinforced_stardust_boots
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_essence"}}},{Count:1b,id:"minecraft:stone_sword",tag:{stardust:{damaged:1b}}}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/reinforced_stardust_sword
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_essence"}}},{Count:1b,id:"minecraft:stone_pickaxe",tag:{stardust:{damaged:1b}}}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/reinforced_stardust_pickaxe
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_essence"}}},{Count:1b,id:"minecraft:stone_axe",tag:{stardust:{damaged:1b}}}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/reinforced_stardust_axe

#Original Stardust Equipments
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_config"}}},{Count:1b,id:"minecraft:leather_helmet",tag:{stardust:{reinforced:1b}}}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/original_stardust_helmet
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_config"}}},{Count:1b,id:"minecraft:leather_chestplate",tag:{stardust:{reinforced:1b}}}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/original_stardust_chestplate
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_config"}}},{Count:1b,id:"minecraft:leather_leggings",tag:{stardust:{reinforced:1b}}}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/original_stardust_leggings
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_config"}}},{Count:1b,id:"minecraft:leather_boots",tag:{stardust:{reinforced:1b}}}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/original_stardust_boots
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_config"}}},{Count:1b,id:"minecraft:iron_sword",tag:{stardust:{reinforced:1b}}}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/original_stardust_sword
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_config"}}},{Count:1b,id:"minecraft:iron_pickaxe",tag:{stardust:{reinforced:1b}}}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/original_stardust_pickaxe
	execute store result score @s smithed.data if entity @s[scores={smithed.data=0}] if score count smithed.data matches 2 if data storage smithed.crafter:input {recipe:[{Count:8b,tag:{ctc:{id:"stardust_config"}}},{Count:1b,id:"minecraft:iron_axe",tag:{stardust:{reinforced:1b}}}]} run loot replace block ~ ~ ~ container.16 loot stardust:i/original_stardust_axe
