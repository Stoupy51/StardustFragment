...
#Wormhole Potion
    ...
    execute if entity @s[tag=!SF_WaitingCraft] if block ~ ~ ~ barrel{Items:[{Slot:2b,tag:{SF_WormholePotion:1s}},{Slot:3b,tag:{SF_WormholePotion:1s}},{Slot:4b,tag:{SF_WormholePotion:1s}},{Slot:11b,tag:{SF_WormholePotion:1s}},{Slot:12b,tag:{SF_WormholePotion:1s}},{Slot:13b,tag:{SF_WormholePotion:1s}},{Slot:20b,tag:{SF_WormholePotion:1s}},{Slot:21b,tag:{SF_WormholePotion:1s}},{Slot:22b,tag:{SF_WormholePotion:1s}}]} run function stardust:craft/items/wormhole_potion_x9
#Diamond Seeds
...
#Celestial Portal
    execute if entity @s[tag=!SF_WaitingCraft] unless data block ~ ~ ~ Items[{Slot:12b}] if block ~ ~ ~ barrel{Items:[{Slot:2b,id:"minecraft:iron_block"},{Slot:3b,id:"minecraft:iron_block"},{Slot:4b,id:"minecraft:iron_block"},{Slot:11b,id:"minecraft:iron_block"},{Slot:13b,id:"minecraft:iron_block"},{Slot:20b,id:"minecraft:iron_block"},{Slot:21b,id:"minecraft:iron_block"},{Slot:22b,id:"minecraft:iron_block"}]} run function stardust:craft/items/portals/celestial
#Stoupy's Egg
