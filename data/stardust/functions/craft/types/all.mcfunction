#Stardust Fragment Crafts
    execute if entity @s[tag=!SF_WaitingCraft] if data storage stardust:items Crafting[{tag:{SF_StardustFragment:1s}}] run function stardust:craft/types/stardust_fragment
#Stardust Ingot Crafts
    execute if entity @s[tag=!SF_WaitingCraft] if data storage stardust:items Crafting[{tag:{SF_StardustIngot:1s}}] run function stardust:craft/types/stardust_ingot
...
#Awakened Stardust Block Crafts
    execute if entity @s[tag=!SF_WaitingCraft] if data storage stardust:items Crafting[{tag:{SF_AwakenedStardustBlock:1s}}] run function stardust:craft/types/awakened_stardust_block
#Compacted Stardust Crafts
    execute if entity @s[tag=!SF_WaitingCraft] if data storage stardust:items Crafting[{tag:{SF_CompactedStardust:1s}}] run function stardust:craft/types/compacted_stardust
...
#Ultimate Core Crafts
    execute if entity @s[tag=!SF_WaitingCraft] if data storage stardust:items Crafting[{tag:{SF_UltimateCore:1s}}] run function stardust:craft/types/ultimate_core
