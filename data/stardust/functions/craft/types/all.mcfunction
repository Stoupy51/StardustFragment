...
#Stardust Ingot Crafts
	execute as @s[tag=!SF_FoundCraft] if data storage stardust:items Crafting[{tag:{SF_StardustIngot:1s}}] run function stardust:craft/types/stardust_ingot
#Stardust Essence Crafts
	execute as @s[tag=!SF_FoundCraft] if data storage stardust:items Crafting[{tag:{SF_StardustEssence:1s}}] run function stardust:craft/types/stardust_essence
#Stardust Config Crafts
	execute as @s[tag=!SF_FoundCraft] if data storage stardust:items Crafting[{tag:{SF_StardustConfig:1s}}] run function stardust:craft/types/stardust_config
#Stardust Block
	execute as @s[tag=!SF_FoundCraft] if data storage stardust:items Crafting[{tag:{SF_StardustBlock:1s}}] run function stardust:craft/types/stardust_block
#Awakened Stardust Crafts
	execute as @s[tag=!SF_FoundCraft] if data storage stardust:items Crafting[{tag:{SF_AwakenedStardust:1s}}] run function stardust:craft/types/awakened_stardust
#Awakened Stardust Block Crafts
	execute as @s[tag=!SF_FoundCraft] if data storage stardust:items Crafting[{tag:{SF_AwakenedStardustBlock:1s}}] run function stardust:craft/types/awakened_stardust_block
#Compacted Stardust Crafts
	execute as @s[tag=!SF_FoundCraft] if data storage stardust:items Crafting[{tag:{SF_CompactedStardust:1s}}] run function stardust:craft/types/compacted_stardust
...
#Solar Fragment Crafts
	execute as @s[tag=!SF_FoundCraft] if data storage stardust:items Crafting[{tag:{SF_SolarFragment:1s}}] run function stardust:craft/types/solar_fragment
...
#Ultimate Core Crafts
	execute as @s[tag=!SF_FoundCraft] if data storage stardust:items Crafting[{tag:{SF_UltimateCore:1s}}] run function stardust:craft/types/ultimate_core
