...
#No Craft Found
	execute as @s[tag=!SF_FoundCraft] unless data storage stardust:items all.Crafting[{Slot:16b,tag:{SF_LegendaryFragment:1b}}] run function stardust:craft/no_craft_found
