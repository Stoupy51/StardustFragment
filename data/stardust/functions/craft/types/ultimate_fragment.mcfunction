#Ultimate Wire
	execute as @s[tag=!SF_FoundCraft] if block ~ ~ ~ barrel{Items:[{Slot:2b,tag:{SF_UltimateFragment:1b}},{Slot:3b,tag:{SF_UltimateFragment:1b}},{Slot:4b,tag:{SF_UltimateFragment:1b}},{Slot:11b,tag:{SF_UltimateFragment:1b}},{Slot:12b,tag:{SF_AwakenedStardustWire:1b}},{Slot:13b,tag:{SF_UltimateFragment:1b}},{Slot:22b,tag:{SF_UltimateFragment:1b}},{Slot:21b,tag:{SF_UltimateFragment:1b}},{Slot:22b,tag:{SF_UltimateFragment:1b}}]} run function stardust:craft/items/ultimate/ultimate_wire
#Ultimate Battery
