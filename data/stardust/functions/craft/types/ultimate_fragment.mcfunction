...
#Lucky Artifact Bag
	execute as @s[tag=!SF_FoundCraft] unless data storage stardust:items all.Crafting[{Slot:3b}] if block ~ ~ ~ barrel{Items:[{Slot:2b,id:"minecraft:leather"},{Slot:4b,id:"minecraft:leather"},{Slot:11b,id:"minecraft:leather"},{Slot:12b,tag:{SF_UltimateFragment:1b}},{Slot:13b,id:"minecraft:leather"},{Slot:20b,id:"minecraft:leather"},{Slot:21b,id:"minecraft:leather"},{Slot:22b,id:"minecraft:leather"}]} run function stardust:craft/items/lucky_artifact_bag

#No Craft Found
	execute as @s[tag=!SF_FoundCraft] unless data storage stardust:items all.Crafting[{Slot:16b,tag:{SF_UltimateFragment:1b}}] run function stardust:craft/no_craft_found
