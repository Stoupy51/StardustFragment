#Materials
    ...
    #All Compressed Cobblestones
        ...
        execute as @e[type=glow_item_frame,tag=SF_TripleCompressedCobblestone] at @s unless block ~ ~ ~ minecraft:cobblestone run function stardust:destroy/cobblestone/triple_compressed
        execute as @e[type=glow_item_frame,tag=SF_QuadrupleCompressedCobblestone] at @s unless block ~ ~ ~ minecraft:cobblestone run function stardust:destroy/cobblestone/quadruple_compressed
        execute as @e[type=glow_item_frame,tag=SF_QuintupleCompressedCobblestone] at @s unless block ~ ~ ~ minecraft:cobbled_deepslate run function stardust:destroy/cobblestone/quintuple_compressed
        execute as @e[type=glow_item_frame,tag=SF_SextupleCompressedCobblestone] at @s unless block ~ ~ ~ minecraft:cobbled_deepslate run function stardust:destroy/cobblestone/sextuple_compressed
...
#Others
    ...
    execute as @e[type=glow_item_frame,tag=SF_CobblestoneMiner] at @s unless block ~ ~ ~ minecraft:cobbled_deepslate run function stardust:destroy/cobblestone_miner
    execute as @e[type=glow_item_frame,tag=SF_Quarry] at @s unless block ~ ~ ~ minecraft:barrel run function stardust:destroy/quarry
    execute as @e[type=glow_item_frame,tag=SF_CavernPortal] at @s unless block ~ ~ ~ minecraft:cobbled_deepslate run function stardust:destroy/cavern_portal
    ...
    execute as @e[type=glow_item_frame,tag=SF_StardustPortal] at @s unless block ~ ~ ~ minecraft:lapis_block run function stardust:destroy/stardust_portal
    execute as @e[type=glow_item_frame,tag=SF_DungeonPortal] at @s unless block ~ ~ ~ minecraft:redstone_block run function stardust:destroy/stardust_dungeon_portal
    ...
    execute as @e[type=glow_item_frame,tag=SF_MobGrinder] at @s unless block ~ ~ ~ minecraft:cobbled_deepslate run function stardust:destroy/mob_grinder
    ...
    execute as @e[type=glow_item_frame,tag=SF_AwakenedStardustBattery] at @s unless block ~ ~ ~ minecraft:redstone_block run function stardust:destroy/awakened_stardust_battery
