#Replace the item to keep Motion
	...
	execute store result entity @e[type=item,nbt={Item:{tag:{SF_StardustFragment:1b}}},limit=1,sort=nearest,distance=..1] Item.Count byte 1 run scoreboard players get Count SF_Data
