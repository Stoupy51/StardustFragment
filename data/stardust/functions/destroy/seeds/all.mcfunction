...
execute unless entity @e[type=item,nbt={Item:{id:"minecraft:moss_carpet"}},limit=1,sort=nearest,distance=..1] run summon minecraft:item ~ ~ ~ {Motion:[0.00,0.20,0.00],Item:{id:"minecraft:moss_carpet",Count:1b}}
tag @e[type=item,nbt={Item:{id:"minecraft:moss_carpet"}},limit=1,sort=nearest,distance=..1] add SF_Drop
