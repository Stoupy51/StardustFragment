summon glow_item_frame ~ ~-1 ~ {ItemRotation:0b,Tags:["SF_Destroyer","SF_Portal","SF_CavernPortal","SF_InfiniteEnergy"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"minecraft:barrel",Count:1b,tag:{CustomModelData:2013219}}}
