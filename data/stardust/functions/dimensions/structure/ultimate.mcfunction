...
execute as @e[distance=0..,type=!#energy:valid_block_entities,tag=!global.ignore,tag=!smithed.entity] at @s unless block ~ ~1 ~ air run function stardust:boss/ultimate_boss/tp_up
