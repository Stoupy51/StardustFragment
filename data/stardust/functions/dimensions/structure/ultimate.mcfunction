scoreboard players set UltimateBuild stardust.data 0
...
execute if score temp stardust.data matches 1 run scoreboard players add UltimateBuild stardust.data 1
...
execute if score UltimateBuild stardust.data matches 22 run function stardust:dimensions/structure/ultimate_build
execute unless score UltimateBuild stardust.data matches 22 run tellraw @a {"text":"Stardust Fragment Error: The Ultimate Dimension couldn't be rebuilt. Something blocked the '/forceload' command in stardust:ultimate","italic":false,"color":"red"}
scoreboard players set #ultimate_built stardust.data 1
scoreboard players reset UltimateBuild stardust.data
