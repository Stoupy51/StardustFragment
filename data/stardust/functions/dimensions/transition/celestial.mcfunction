execute in stardust:celestial positioned ~-50 ~-250 ~-50 unless entity @e[type=glow_item_frame,tag=SF_Portal,dx=100,dy=500,dz=100] positioned ~50 ~250 ~50 run function stardust:dimensions/structure/celestial
