...
execute if entity @s[nbt={Dimension:"stardust:dungeon"}] at @s in stardust:stardust run tp @s ~ 475 ~
execute if entity @s[nbt={Dimension:"stardust:ultimate"}] at @s in stardust:stardust run tp @s ~ 475 ~
