...
execute unless score @s bp.1_second matches 0.. if predicate stardust:in_celestial at @s in minecraft:overworld run function stardust:dimensions/transition_down_2
