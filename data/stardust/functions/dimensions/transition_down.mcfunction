...
execute if entity @s[nbt={Dimension:"stardust:celestial"}] run advancement grant @s only stardust:visible/adventure/falling_celestial
...
execute if entity @s[nbt={Dimension:"stardust:stardust"}] run advancement grant @s only stardust:visible/adventure/falling_stardust
