...
execute as @s[nbt={Dimension:"stardust:celestial"}] run advancement grant @s only stardust:falling_celestial
execute as @s[nbt={Dimension:"stardust:celestial"}] at @s in minecraft:overworld run tp @s ~ 475 ~
execute as @s[nbt={Dimension:"stardust:stardust"}] run advancement grant @s only stardust:falling_stardust
