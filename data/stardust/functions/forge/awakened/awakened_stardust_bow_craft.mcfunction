#Kill materials + Sound + Visual
	...
	kill @e[type=item,nbt={Item:{Count:16b,tag:{StardustFragment_EnderDragonPearl:1b}}},limit=1,sort=nearest,distance=..1]
...
#SpawnItem
	...
	data modify entity @e[type=item,nbt={Item:{tag:{StardustFragment_Give:1b}}},limit=1,distance=..1] Item set from storage stardust:items all.2013150
