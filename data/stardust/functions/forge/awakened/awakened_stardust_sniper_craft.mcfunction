#Kill materials + Sound + Visual
	...
	kill @e[type=item,nbt={Item:{Count:24b,tag:{SF_EnderDragonPearl:1s}}},limit=1,sort=nearest,distance=..1]
...
#SpawnItem
	...
	data modify entity @e[type=item,nbt={Item:{tag:{SF_Give:1s}}},limit=1,distance=..1] Item set from storage stardust:items 2013153
