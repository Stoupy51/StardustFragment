...
#SpawnItem
	...
	execute as @s[scores={SF_SCraft=4..}] run data modify entity @e[type=item,nbt={Item:{tag:{SF_Give:1s}}},limit=1,distance=..1] Item set from storage stardust:items 2013138
