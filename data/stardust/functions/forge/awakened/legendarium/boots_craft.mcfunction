#SpawnItem
	...
	data modify entity @e[type=item,nbt={Item:{tag:{stardust.give:1b}}},limit=1,distance=..1] Item set from storage stardust:main all.2013124

#Kill materials + Sound + Visual
	kill @e[type=item,nbt={Item:{Count:8b,tag:{stardust:{legendarium_fragment:1b}}}},limit=1,sort=nearest,distance=..1]
