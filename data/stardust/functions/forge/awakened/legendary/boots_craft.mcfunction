#SpawnItem
	...
	data modify entity @e[type=item,nbt={Item:{tag:{SF_Give:1b}}},limit=1,distance=..1] Item set from storage stardust:items all.2013124

#Kill materials + Sound + Visual
	kill @e[type=item,nbt={Item:{Count:8b,tag:{SF_LegendaryFragment:1b}}},limit=1,sort=nearest,distance=..1]
