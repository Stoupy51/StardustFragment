...
execute as @s[scores={SF_SCraft=5..}] run summon item ~ ~ ~ {Motion:[0.0,1.0,0.0],Item:{id:"minecraft:iron_nugget",Count:1b,tag:{ArtDmgMax:1b,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:0.5,Operation:1,UUID:[I;20,20,20,20]}],HideFlags:127,display:{Lore:['{"text":" "}','[{"text":"[+50% de Dégâts]","italic":false,"color":"white"}]'],Name:'[{"text":"Artefact de dégâts Lv.Max","italic":false,"color":"gold"}]'}}}}
