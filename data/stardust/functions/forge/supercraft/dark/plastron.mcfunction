...
execute as @s[scores={SF_SCraft=5..}] run summon item ~ ~ ~ {Motion:[0.0,1.0,0.0],Item:{id:"minecraft:leather_chestplate",Count:1b,tag:{Unbreakable:1b,PT:1b,AttributeModifiers:[{AttributeName:"generic.knockback_resistance",Name:"generic.knockback_resistance",Slot:"chest",Amount:5,Operation:0,UUID:[I;2,2,2,2]},{AttributeName:"generic.armor",Name:"generic.armor",Slot:"chest",Amount:10,Operation:0,UUID:[I;2,2,2,3]},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Slot:"chest",Amount:4,Operation:0,UUID:[I;2,2,3,3]}],HideFlags:126,display:{"color":0,Lore:['{"text":" "}','[{"text":"[+5 Résistance au recul]","italic":false,"color":"white"}]'],Name:'[{"text":"Plastron Ténébreux","italic":false,"color":"dark_gray"}]'},Enchantments:[{lvl:10,id:"minecraft:thorns"},{lvl:7,id:"minecraft:protection"},{lvl:7,id:"minecraft:projectile_protection"},{lvl:7,id:"minecraft:blast_protection"}]}}}
