...
execute as @s[scores={SF_SCraft=5..}] run summon item ~ ~ ~ {Motion:[0.0,1.0,0.0],Item:{id:"minecraft:enderman_spawn_egg",Count:1b,tag:{GTe:1b,EntityTag:{id:"minecraft:area_effect_cloud",Age:0,Duration:0,Radius:0f,Tags:["GTe","StarSeed","SFegg"],NoAI:1b,Silent:1,ActiveEffects:[{Id:14,Amplifier:0,Duration:20,ShowParticles:0b}]},HideFlags:127,display:{Lore:['[{"text":"Elle ne se plante seulement","color":"white","italic":false}]','[{"text":"sur des blocs de béton noir.","color":"white","italic":false}]'],Name:'[{"text":"Graine Ténébreuse","color":"dark_gray","italic":false}]'}}}}
