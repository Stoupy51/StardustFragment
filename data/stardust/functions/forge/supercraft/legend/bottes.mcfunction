...
execute as @s[scores={SF_SCraft=5..}] run summon item ~ ~ ~ {Motion:[0.0,1.0,0.0],Item:{id:"minecraft:leather_boots",Count:1b,tag:{Unbreakable:1b,BL:1b,AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Slot:"feet",Amount:3,Operation:0,UUID:[I;4,4,4,5]},{AttributeName:"generic.armor_toughness",Name:"generic.armor_toughness",Slot:"feet",Amount:2,Operation:0,UUID:[I;4,4,5,5]},{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Slot:"feet",Amount:0.01,Operation:0,UUID:[I;4,5,5,5]}],HideFlags:126,display:{"color":65280,Lore:['{"text":" "}','[{"text":"[+10% de vitesse de base]","italic":false,"color":"white"}]'],Name:'[{"text":"Bottes Légendaires","italic":false,"color":"green"}]'},Enchantments:[{lvl:10,id:"minecraft:feather_falling"},{lvl:5,id:"minecraft:protection"},{lvl:5,id:"minecraft:projectile_protection"},{lvl:5,id:"minecraft:blast_protection"}]}}}
execute as @s[scores={SF_SCraft=5..}] run kill @e[type=minecraft:item,nbt={Item:{Count:1b,tag:{BO:1b}}},limit=1,sort=nearest,distance=..1]
