...
execute as @s[scores={SF_SCraft=5..}] run summon item ~ ~ ~ {Motion:[0.0,1.0,0.0],Item:{id:"minecraft:creeper_spawn_egg",Count:1b,tag:{GLe:1b,EntityTag:{id:"minecraft:area_effect_cloud",Age:0,Duration:0,Radius:0f,Tags:["GLe","StarSeed","SFegg"],NoAI:1b,Silent:1,ActiveEffects:[{Id:14,Amplifier:0,Duration:20,ShowParticles:0b}]},HideFlags:127,display:{Lore:['[{"text":"Elle ne se plante seulement","italic":false,"color":"white"}]','[{"text":"sur des blocs de béton vert clair.","italic":false,"color":"white"}]'],Name:'[{"text":"Graine Légendaire","italic":false,"color":"green"}]'}}}}
