...
execute at @e[type=item,nbt={Item:{id:"minecraft:ender_pearl",Count:16b}},limit=2,sort=nearest,distance=..1] run scoreboard players add @s SF_X 1
execute at @e[type=item,nbt={Item:{id:"minecraft:dragon_breath",Count:64b}},limit=1,sort=nearest,distance=..1] at @e[type=item,nbt={Item:{id:"minecraft:nether_star",Count:4b}},limit=1,sort=nearest,distance=..1] at @e[type=item,nbt={Item:{Count:4b,tag:{L:1b}}},limit=1,sort=nearest,distance=..1] run scoreboard players add @s SF_X 1
...
execute as @s[scores={SF_SCraft=5..}] run kill @e[type=item,nbt={Item:{id:"minecraft:dragon_breath",Count:64b}},limit=1,sort=nearest,distance=..1]
execute as @s[scores={SF_SCraft=5..}] run kill @e[type=item,nbt={Item:{id:"minecraft:nether_star",Count:4b}},limit=1,sort=nearest,distance=..1]
execute as @s[scores={SF_SCraft=5..}] run kill @e[type=item,nbt={Item:{Count:4b,tag:{L:1b}}},limit=1,sort=nearest,distance=..1]
