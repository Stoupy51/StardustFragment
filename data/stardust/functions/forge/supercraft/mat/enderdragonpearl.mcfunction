...
execute at @e[type=item,nbt={Item:{id:"minecraft:ender_pearl",Count:16b}},limit=4,sort=nearest,distance=..1] run scoreboard players add @s SF_X 1
execute at @e[type=item,nbt={Item:{id:"minecraft:dragon_breath",Count:16b}},limit=1,sort=nearest,distance=..1] run scoreboard players add @s SF_X 1
...
execute as @s[scores={SF_SCraft=5..}] run kill @e[type=item,nbt={Item:{id:"minecraft:ender_pearl",Count:16b}},limit=4,sort=nearest,distance=..1]
execute as @s[scores={SF_SCraft=5..}] run kill @e[type=item,nbt={Item:{id:"minecraft:dragon_breath",Count:16b}},limit=1,sort=nearest,distance=..1]
