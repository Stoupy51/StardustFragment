...
execute as @s[scores={SF_SCraft=5..}] run summon item ~ ~ ~ {Motion:[0.0,1.0,0.0],Item:{id:"minecraft:diamond_axe",Count:1b,tag:{HS:1b,HideFlags:126,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Slot:"mainhand",Amount:35,Operation:0,UUID:[I;5,5,5,5]}],display:{Lore:['{"text":" "}','[{"text":"[35 Dégâts par coup]","italic":false,"color":"white"}]'],Name:'[{"text":"Hache Solaire","italic":false,"color":"gold"}]'},Enchantments:[{lvl:10,id:"minecraft:unbreaking"},{lvl:10,id:"minecraft:efficiency"},{lvl:1,id:"minecraft:fortune"}]}}}
