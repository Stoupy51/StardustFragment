#SpawnItem
	...
	data modify entity @e[type=item,nbt={Item:{tag:{stardust.give:1b}}},limit=1,distance=..1] Item set from storage stardust:items all.2013151

#Kill materials + Sound + Visual
	kill @e[type=item,nbt={Item:{Count:1b,tag:{stardust:{awakened_stardust_bow:1b}}}},limit=1,sort=nearest,distance=..1]
