...
#Kill materials + Sound + Visual
	...
	kill @e[type=item,nbt={Item:{Count:1b,tag:{stardust:{solar_leggings:1b}}}},limit=1,sort=nearest,distance=..1]
	kill @e[type=item,nbt={Item:{Count:1b,tag:{stardust:{dark_leggings:1b}}}},limit=1,sort=nearest,distance=..1]
