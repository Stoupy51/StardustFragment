#SpawnItem
	...
	data modify entity @e[type=item,nbt={Item:{tag:{SF_Give:1b}}},limit=1,distance=..1] Item set from storage stardust:items all.2013154

#Kill materials + Sound + Visual
	kill @e[type=item,nbt={Item:{Count:1b,tag:{SF_AwakenedStardustSniper:1b}}},limit=1,sort=nearest,distance=..1]
