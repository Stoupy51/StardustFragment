...
execute as @s[scores={SF_SCraft=10..}] run kill @e[type=item,nbt={Item:{tag:{HT:1b}}},limit=1,sort=nearest,distance=..1]
execute as @s[scores={SF_SCraft=10..}] run kill @e[type=item,nbt={Item:{tag:{HS:1b}}},limit=1,sort=nearest,distance=..1]
