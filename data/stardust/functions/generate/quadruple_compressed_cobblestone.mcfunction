...
#Placing Ore
	execute at @s if block ~ ~ ~ #stardust:for_stardust_ore run summon minecraft:glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SF_Destroyer","SF_DestroyCobblestone","SF_QuadrupleCompressedCobblestone"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"minecraft:barrel",Count:1b,tag:{CustomModelData:2013018}}}
	execute at @s if block ~ ~ ~ #stardust:for_stardust_ore run setblock ~ ~ ~ minecraft:cobblestone
	execute at @s positioned ~0.75 ~0.75 ~0.75 if block ~ ~ ~ #stardust:for_stardust_ore run summon minecraft:glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SF_Destroyer","SF_DestroyCobblestone","SF_QuadrupleCompressedCobblestone"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"minecraft:barrel",Count:1b,tag:{CustomModelData:2013018}}}
