...
#Placing Ore
	...
	execute at @s if block ~ ~ ~ #stardust:for_stardust_ore run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SimplEnergy_Destroyer","SimplEnergy_SimpluniumOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2012899}}}
	execute at @s if block ~ ~ ~ #stardust:for_stardust_ore run setblock ~ ~ ~ cobbled_deepslate
	execute at @s positioned ~0.8 ~0.8 ~0.8 if block ~ ~ ~ #stardust:for_stardust_ore run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SimplEnergy_Destroyer","SimplEnergy_SimpluniumOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2012899}}}
	execute at @s positioned ~0.8 ~0.8 ~0.8 if block ~ ~ ~ #stardust:for_stardust_ore run setblock ~ ~ ~ cobbled_deepslate
	execute at @s positioned ~ ~0.8 ~0.8 if block ~ ~ ~ #stardust:for_stardust_ore run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SimplEnergy_Destroyer","SimplEnergy_SimpluniumOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2012899}}}
	execute at @s positioned ~ ~0.8 ~0.8 if block ~ ~ ~ #stardust:for_stardust_ore run setblock ~ ~ ~ cobbled_deepslate
	execute at @s positioned ~0.8 ~0.8 ~ if block ~ ~ ~ #stardust:for_stardust_ore run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SimplEnergy_Destroyer","SimplEnergy_SimpluniumOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2012899}}}
	execute at @s positioned ~0.8 ~0.8 ~ if block ~ ~ ~ #stardust:for_stardust_ore run setblock ~ ~ ~ cobbled_deepslate
	execute at @s positioned ~0.8 ~ ~0.8 if block ~ ~ ~ #stardust:for_stardust_ore run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SimplEnergy_Destroyer","SimplEnergy_SimpluniumOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2012899}}}
	execute at @s positioned ~0.8 ~ ~0.8 if block ~ ~ ~ #stardust:for_stardust_ore run setblock ~ ~ ~ cobbled_deepslate
	execute at @s positioned ~ ~0.8 ~ if block ~ ~ ~ #stardust:for_stardust_ore run summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SimplEnergy_Destroyer","SimplEnergy_SimpluniumOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2012899}}}
