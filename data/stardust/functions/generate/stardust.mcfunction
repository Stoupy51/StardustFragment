...
#I divide values by 25 to keep a digit
...
#Z can take a value between -40 & +40   Examples : -37.4, 14.3, 0.1, ...
    ...
    scoreboard players set 25 SF_Data 25
    ...
    execute store result score PosX SF_Data run data get entity @s Pos[0] 25
    execute store result score PosZ SF_Data run data get entity @s Pos[2] 25
...
#Placing Ore
    execute at @s if block ~ ~ ~ #stardust:for_stardust_ore run summon minecraft:glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SF_Destroyer","SF_StardustOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"minecraft:cobblestone",Count:1b,tag:{CustomModelData:2013023}}}
    execute at @s if block ~ ~ ~ #stardust:for_stardust_ore run setblock ~ ~ ~ minecraft:deepslate_diamond_ore
    execute at @s positioned ~0.5 ~0.5 ~0.5 if block ~ ~ ~ #stardust:for_stardust_ore run summon minecraft:glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SF_Destroyer","SF_StardustOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"minecraft:cobblestone",Count:1b,tag:{CustomModelData:2013023}}}
    execute at @s positioned ~0.5 ~0.5 ~0.5 if block ~ ~ ~ #stardust:for_stardust_ore run setblock ~ ~ ~ minecraft:deepslate_diamond_ore
    execute at @s positioned ~ ~0.5 ~0.5 if block ~ ~ ~ #stardust:for_stardust_ore run summon minecraft:glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SF_Destroyer","SF_StardustOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"minecraft:cobblestone",Count:1b,tag:{CustomModelData:2013023}}}
    execute at @s positioned ~ ~0.5 ~0.5 if block ~ ~ ~ #stardust:for_stardust_ore run setblock ~ ~ ~ minecraft:deepslate_diamond_ore
    execute at @s positioned ~0.5 ~0.5 ~ if block ~ ~ ~ #stardust:for_stardust_ore run summon minecraft:glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SF_Destroyer","SF_StardustOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"minecraft:cobblestone",Count:1b,tag:{CustomModelData:2013023}}}
    execute at @s positioned ~0.5 ~0.5 ~ if block ~ ~ ~ #stardust:for_stardust_ore run setblock ~ ~ ~ minecraft:deepslate_diamond_ore
    execute at @s positioned ~0.5 ~ ~0.5 if block ~ ~ ~ #stardust:for_stardust_ore run summon minecraft:glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SF_Destroyer","SF_StardustOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"minecraft:cobblestone",Count:1b,tag:{CustomModelData:2013023}}}
    execute at @s positioned ~0.5 ~ ~0.5 if block ~ ~ ~ #stardust:for_stardust_ore run setblock ~ ~ ~ minecraft:deepslate_diamond_ore
    execute at @s positioned ~ ~0.5 ~ if block ~ ~ ~ #stardust:for_stardust_ore run summon minecraft:glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SF_Destroyer","SF_StardustOre"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"minecraft:cobblestone",Count:1b,tag:{CustomModelData:2013023}}}
