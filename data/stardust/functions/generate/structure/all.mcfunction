...
#Define a positive value randomly with UUID.
	scoreboard players set 1000 StardustFragment_Data 1000
	...
	scoreboard players operation Random StardustFragment_Data %= 1000 StardustFragment_Data
	execute at @s if entity @e[type=bat,tag=StardustFragment_Structure,distance=..250] run scoreboard players set Random StardustFragment_Data 1000
#Choose a Structure
