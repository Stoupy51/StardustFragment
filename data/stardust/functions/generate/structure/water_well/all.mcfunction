...
#Choose a Structure
	execute if score Temp SF_Data matches 1 at @s run setblock ~ ~1 ~ minecraft:structure_block{posX:-2,mode:"LOAD",posY:-5,posZ:-2,sizeX:6,sizeY:9,sizeZ:6,name:"stardust:water_well"}
