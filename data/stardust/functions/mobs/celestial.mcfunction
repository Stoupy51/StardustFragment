data modify entity @s ArmorDropChances set value [0.1F,0.05F,0.25F,2F]
...
data modify entity @s ArmorItems[2] set from storage simplenergy:items 2012898
data modify entity @s ArmorItems[0].Count set value 1b
data modify entity @s ArmorItems[1].Count set value 2b
data modify entity @s ArmorItems[2].Count set value 1b
data modify entity @s ArmorItems[3] set value {Item:{id:"minecraft:iron_ingot",Count:1b}}
