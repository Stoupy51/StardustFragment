...
execute store success score #success stardust.data run data modify storage stardust:main temp set from entity @e[type=stray,tag=stardust.stardust_dim,dx=0,dy=0,dz=0,predicate=stardust:equals_id,limit=1]
