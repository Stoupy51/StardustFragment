...
#FinalStep
	...
	execute as @s[tag=SF_DiamondSeeds,scores={SF_Data=120..}] run tag @s add SF_SeedDone
	execute as @s[tag=SF_StardustSeeds,scores={SF_Data=40..}] run tag @s add SF_SeedDone
	execute as @s[tag=SF_ElementarySeeds,scores={SF_Data=1440..}] run tag @s add SF_SeedDone
