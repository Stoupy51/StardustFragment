...
#FirstStep
	...
	data modify entity @s[tag=stardust.legendary_seed,scores={stardust.data=720..729}] Item.tag.CustomModelData set value 2013213
	data modify entity @s[tag=stardust.solar_seed,scores={stardust.data=720..729}] Item.tag.CustomModelData set value 2013214
	data modify entity @s[tag=stardust.dark_seed,scores={stardust.data=720..729}] Item.tag.CustomModelData set value 2013215
#FinalStep
	...
	data modify entity @s[tag=stardust.legendary_seed,scores={stardust.data=1440..}] Item.tag.CustomModelData set value 2013221
	data modify entity @s[tag=stardust.solar_seed,scores={stardust.data=1440..}] Item.tag.CustomModelData set value 2013222
	data modify entity @s[tag=stardust.dark_seed,scores={stardust.data=1440..}] Item.tag.CustomModelData set value 2013223
