#Timer
	...
	execute if entity @s[tag=StardustFragment_Seed] if block ~ ~-2 ~ minecraft:dragon_egg run scoreboard players add @s StardustFragment_Data 4
	execute if entity @s[tag=StardustFragment_Seed] if block ~ ~-2 ~ minecraft:dragon_egg if block ~ ~-3 ~ minecraft:netherite_block run scoreboard players add @s StardustFragment_Data 5
#FirstStep
...
#FinalStep
	...
	execute if entity @s[tag=StardustFragment_DiamondSeeds,scores={StardustFragment_Data=120..}] run tag @s add StardustFragment_SeedDone
	execute if entity @s[tag=StardustFragment_StardustSeeds,scores={StardustFragment_Data=40..}] run tag @s add StardustFragment_SeedDone
	execute if entity @s[tag=StardustFragment_ElementarySeeds,scores={StardustFragment_Data=1440..}] run tag @s add StardustFragment_SeedDone
