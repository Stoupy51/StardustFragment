...
summon item_frame ~ ~ ~ {ItemRotation:0b,Tags:["global.ignore","global.ignore.kill","smithed.block","stardust.destroyer","stardust.destroy_player_head","stardust.awakened_stardust_cable","simplenergy.cable","stardust.set_new","energy.cable"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2013500}}}
execute as @e[type=item_frame,tag=stardust.set_new,limit=1] at @s run function stardust:place/awakened_stardust_cable/secondary
kill @s
