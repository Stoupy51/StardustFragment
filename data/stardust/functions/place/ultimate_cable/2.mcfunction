...
summon item_frame ~ ~ ~ {ItemRotation:0b,Tags:["global.ignore","global.ignore.kill","smithed.block","StardustFragment_Destroyer","StardustFragment_DestroyPlayerHead","StardustFragment_UltimateCable","SimplEnergy_Cable","StardustFragment_SetNew","energy.cable"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"cobblestone",Count:1b,tag:{CustomModelData:2013600}}}
kill @s
