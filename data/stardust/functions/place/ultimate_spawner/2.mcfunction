...
data modify block ~ ~ ~ SpawnData.entity.Item set from storage stardust:items 2013000
data modify block ~ ~ ~ SpawnPotentials[0].data.entity.Item set from storage stardust:items 2013000
...
data modify block ~ ~ ~ SpawnPotentials[6].data.entity.Item set from storage stardust:items 2013229
...
data modify block ~ ~ ~ SpawnPotentials[9].data.entity.Item set from storage stardust:items 2013003
data modify block ~ ~ ~ SpawnPotentials[10].data.entity.Item set value {id:"minecraft:dragon_egg",Count:1b}
data modify block ~ ~ ~ SpawnPotentials[11].data.entity.Item set from storage stardust:items 2013005
data modify block ~ ~ ~ SpawnPotentials[12].data.entity.Item set value {id:"minecraft:nether_star",Count:4b}
data modify block ~ ~ ~ SpawnPotentials[13].data.entity.Item set from storage stardust:items 2013228
data modify block ~ ~ ~ SpawnPotentials[14].data.entity.Item set from storage stardust:items 2013006
data modify block ~ ~ ~ SpawnPotentials[15].data.entity.Item set from storage stardust:items 2013008
data modify block ~ ~ ~ SpawnPotentials[16].data.entity.Item set from storage stardust:items 2013009
data modify block ~ ~ ~ SpawnPotentials[17].data.entity.Item set from storage stardust:items 2013010
data modify block ~ ~ ~ SpawnPotentials[18].data.entity.Item set value {id:"minecraft:netherite_block",Count:16b}

summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["SF_Destroyer","SF_DestroySpawner","SF_UltimateSpawner"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"minecraft:barrel",Count:1b,tag:{CustomModelData:2013226}}}
