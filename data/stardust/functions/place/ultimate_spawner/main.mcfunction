...
setblock ~ ~ ~ spawner{SpawnCount:1,SpawnData:{entity:{id:"minecraft:item",Item:{id:"minecraft:diamond",Count:1b}}},SpawnPotentials:[{weight:500,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:150,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:120,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:100,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:80,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:50,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:50,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:25,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:20,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:15,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:10,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:9,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:7,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:5,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:2,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:2,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:2,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:2,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}},{weight:1,data:{entity:{id:"minecraft:item",Item:{id:"cobblestone",Count:1b}}}}]}
...
summon glow_item_frame ~ ~ ~ {ItemRotation:0b,Tags:["global.ignore","global.ignore.kill","smithed.block","stardust.destroyer","stardust.destroy_spawner","stardust.ultimate_spawner"],Invisible:1b,Invulnerable:1b,Fixed:1b,Silent:1b,Facing:1b,Item:{id:"deepslate",Count:1b,tag:{CustomModelData:2013215}}}
