...
execute if score EF_Missing SF_Data matches 1 run tellraw @a {"text":"Stardust Fragment Error: Energy Flux API v1.2.0+ is missing, click [here] to download","italic":false,"color":"red","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/EnergyFlux-API/releases"}}
...
execute unless score GameVersion EF_Versions matches 2724.. run tellraw @a {"text":"Stardust Fragment Error: You need at least Minecraft 1.17+.","italic":false,"color":"red"}
execute unless score EnergyFlux EF_Versions matches 1020.. run tellraw @a {"text":"Stardust Fragment Error: Energy Flux API v1.2.0+ is needed, click [here] to download","italic":false,"color":"red","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/EnergyFlux-API/releases"}}
execute unless score SimplEnergy EF_Versions matches 1033.. run tellraw @a {"text":"Stardust Fragment Error: SimplEnergy v1.3.3+ is needed, click [here] to download","italic":false,"color":"red","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/SimplEnergy/releases"}}
execute if score GameVersion EF_Versions matches 2724.. if score EnergyFlux EF_Versions matches 1020.. if score SimplEnergy EF_Versions matches 1033.. run tellraw @a {"text":"[Loaded Stardust Fragment v3.0.0]","italic":false,"color":"green"}
