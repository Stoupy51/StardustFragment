...
execute unless score #game_version load.status matches 2975.. run tellraw @a {"text":"Stardust Fragment Error: This version only available with Minecraft 1.18.2+.","italic":false,"color":"red"}
