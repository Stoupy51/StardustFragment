...
execute unless score EnergyFlux EF_Versions matches 1015.. run tellraw @a {"text":"Stardust Fragment Error: Energy Flux API v1.1.5+ is needed, click [here] to download","italic":false,"color":"red","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/EnergyFlux-API/releases"}}
