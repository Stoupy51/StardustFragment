...
execute if score GameVersion EF_Versions matches 2724.. if score EnergyFlux EF_Versions matches 101.. if score SimplEnergy EF_Versions matches 1032.. run tellraw @a {"text":"[Loaded Stardust Fragment v3.0.0]","italic":false,"color":"green"}
