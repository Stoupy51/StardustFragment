...
execute if score SimplEnergy_Missing StardustFragment_Data matches 1 run tellraw @a {"text":"Stardust Fragment Error: SimplEnergy v1.6.0+ is missing, click [here] to download","italic":false,"color":"red","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/SimplEnergy/releases"}}
...
execute unless score SimplEnergy_Missing StardustFragment_Data matches 1 unless score SimplEnergy load.status matches 1060.. run tellraw @a {"text":"Stardust Fragment Error: SimplEnergy v1.6.0+ is required, click [here] to download","italic":false,"color":"red","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/SimplEnergy/releases"}}
