...
execute if score #game_version load.status matches 2975.. if score SimplEnergy load.status matches 1080.. run tellraw @a[tag=convention.debug] {"text":"[Loaded Stardust Fragment v3.4.0]","italic":false,"color":"green"}
