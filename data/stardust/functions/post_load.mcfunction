...
execute if score EF_Missing SF_Data matches 1 run tellraw @a {"text":"Stardust Fragment Error: Energy Flux v1.3.0+ is missing, click [here] to download","italic":false,"color":"red","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/EnergyFlux/releases"}}
execute if score SE_Missing SF_Data matches 1 run tellraw @a {"text":"Stardust Fragment Error: SimplEnergy v1.5.0+ is missing, click [here] to download","italic":false,"color":"red","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/SimplEnergy/releases"}}
...
execute unless score EF_Missing SF_Data matches 1 unless score EnergyFlux load.status matches 1030.. run tellraw @a {"text":"Stardust Fragment Error: Energy Flux v1.3.0+ is needed, click [here] to download","italic":false,"color":"red","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/EnergyFlux/releases"}}
execute unless score SE_Missing SF_Data matches 1 unless score SimplEnergy load.status matches 1050.. run tellraw @a {"text":"Stardust Fragment Error: SimplEnergy v1.5.0+ is needed, click [here] to download","italic":false,"color":"red","clickEvent":{"action":"open_url","value":"https://github.com/Stoupy51/SimplEnergy/releases"}}
execute if score GameVersion load.status matches 2860.. if score EnergyFlux load.status matches 1030.. if score SimplEnergy load.status matches 1050.. run tellraw @a {"text":"[Loaded Stardust Fragment v3.1.0]","italic":false,"color":"green"}
