...
execute at @s positioned ~0.5 ~ ~0.5 run summon shulker ~ ~ ~ {Tags:["stardust.quarry_displaying","stardust.quarryDisplay1"],DeathLootTable:"none",AttachFace:0,Color:14b,Invulnerable:1,NoAI:1,Silent:1,Glowing:1b,Team:"stardust.red"}
