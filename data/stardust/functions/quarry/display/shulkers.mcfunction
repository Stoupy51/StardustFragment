...
execute at @s run summon shulker ~ ~ ~ {Tags:["SF_QuarryDisplayX","SF_QuarryDisplay1"],DeathLootTable:"none",AttachFace:0,Color:14b,Invulnerable:1,NoAI:1,Silent:1,Glowing:1b,Team:"SF_Red"}
...
execute at @s run tp ~0.5 ~ ~0.5
execute at @s run summon shulker ~ ~ ~ {Tags:["SF_QuarryDisplayX","SF_QuarryDisplay2"],DeathLootTable:"none",AttachFace:0,Color:3b,Invulnerable:1,NoAI:1,Silent:1,Glowing:1b,Team:"SF_Blue"}
kill @s
