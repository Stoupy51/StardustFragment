...
data modify storage stardust:main Hopper set from block ~ ~ ~ Items
...
execute if score #success stardust.data matches 1 run data modify block ~ ~ ~ Items append from storage stardust:main Item
