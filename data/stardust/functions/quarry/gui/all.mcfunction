...
execute if block ~ ~-1 ~ minecraft:hopper store success score Success SF_Data run data remove block ~ ~-1 ~ Items[{tag:{SE_CustomTextureItem:1b}}]
execute if block ~ ~-2 ~ minecraft:hopper store success score Success SF_Data run data remove block ~ ~-2 ~ Items[{tag:{SE_CustomTextureItem:1b}}]
