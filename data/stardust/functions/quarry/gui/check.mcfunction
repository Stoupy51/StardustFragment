...
execute unless data storage stardust:items Temp[{Slot:19b,tag:{SF_QuarryStart:1b}}] unless score @s energy.storage matches 625.. run tellraw @a[distance=..7] [{"text":"Not enough energy","italic":false,"color":"red"}]
