...
execute unless data block ~ ~ ~ Items[{Slot:19b,tag:{SF_QuarryStart:1b}}] unless score @s EF_Joule >= @s EF_Watt run tellraw @a[distance=..7] [{"text":"Not enough energy","italic":false,"color":"red"}]
