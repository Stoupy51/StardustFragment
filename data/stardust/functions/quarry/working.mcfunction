...
#Check Size
	...
	execute if entity @s[scores={StardustFragment_StatQ=2},tag=StardustFragment_QuarryLv1] run scoreboard players set Count StardustFragment_Data 50
	execute if entity @s[scores={StardustFragment_StatQ=2},tag=StardustFragment_QuarryLv2] run scoreboard players set Count StardustFragment_Data 100
	execute if entity @s[scores={StardustFragment_StatQ=2},tag=StardustFragment_QuarryLv3] run scoreboard players set Count StardustFragment_Data 150
	execute if entity @s[scores={StardustFragment_StatQ=2},tag=StardustFragment_QuarryLv4] run scoreboard players set Count StardustFragment_Data 200
	execute if entity @s[scores={StardustFragment_StatQ=2},tag=StardustFragment_QuarryLv5] run scoreboard players set Count StardustFragment_Data 250
	execute if entity @s[scores={StardustFragment_StatQ=2},tag=StardustFragment_QuarryLv6] run scoreboard players set Count StardustFragment_Data 2500
