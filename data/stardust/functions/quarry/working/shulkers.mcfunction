...
execute at @s run summon shulker ~ ~ ~ {Tags:["SF_QuarryMiner","SF_QuarryDisplayX"],DeathLootTable:"none",AttachFace:0,Color:0b,Invulnerable:1,NoAI:1,Silent:1,Glowing:1b}
kill @s
