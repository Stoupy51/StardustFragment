...
data modify block -29999999 0 2013 Items append from storage stardust:main quarry.Item
execute if score #slots_count stardust.data matches 27 run function stardust:quarry/working/check_item_count

loot insert ~ ~ ~ mine -29999999 0 2013 minecraft:air{drop_contents:true}
