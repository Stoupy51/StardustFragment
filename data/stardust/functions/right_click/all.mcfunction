...
execute if data storage stardust:main SelectedItemTag.stardust.quarry_configurator run function stardust:right_click/quarry_configurator/
...
execute if data storage stardust:main SelectedItemTag.stardust.travel_staff run function stardust:right_click/travel_staff/
