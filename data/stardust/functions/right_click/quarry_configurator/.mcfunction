...
data modify storage stardust:temp all set from block -30000000 14 1610 Items[0].tag
execute store result storage stardust:temp all.stardust.quarry_x1 int 1 run scoreboard players get Qx1 stardust.data_2
execute store result storage stardust:temp all.stardust.quarry_y1 int 1 run scoreboard players get Qy1 stardust.data_2
execute store result storage stardust:temp all.stardust.quarry_z1 int 1 run scoreboard players get Qz1 stardust.data_2
execute store result storage stardust:temp all.stardust.quarry_x2 int 1 run scoreboard players get Qx2 stardust.data_2
execute store result storage stardust:temp all.stardust.quarry_y2 int 1 run scoreboard players get Qy2 stardust.data_2
execute store result storage stardust:temp all.stardust.quarry_z2 int 1 run scoreboard players get Qz2 stardust.data_2
data modify block -30000000 14 1610 Items[0].tag set from storage stardust:temp all
