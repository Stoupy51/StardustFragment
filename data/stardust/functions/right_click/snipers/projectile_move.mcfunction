...
execute if entity @s[tag=stardust.stardust_sniper] run particle dust 0 0 1 1 ~ ~ ~ .1 .1 .1 0 1 normal @a[distance=..10]
execute if entity @s[tag=stardust.awakened_stardust_sniper] run particle dust 1 0 0 1 ~ ~ ~ .1 .1 .1 0 1 normal @a[distance=..10]
execute if entity @s[tag=stardust.ultimate_sniper] run particle dust 255 255 255 1 ~ ~ ~ .1 .1 .1 0 1 normal @a[distance=..10]
