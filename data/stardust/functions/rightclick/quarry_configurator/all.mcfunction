...
data modify storage stardust:main temp set from block -29999999 0 2013 Items[0].tag
...
data modify block -29999999 0 2013 Items[0].tag set from storage stardust:main temp
