...
execute store result entity @s AbsorptionAmount int 1 run scoreboard players get Absorption SF_Data
...
execute store result entity @s Health int 1 run scoreboard players get Health SF_Data
