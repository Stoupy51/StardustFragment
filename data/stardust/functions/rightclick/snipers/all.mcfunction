...
#Check what Sniper is it and set Base Damage
	execute as @s[nbt={SelectedItem:{tag:{SF_StardustSniper:1b}}}] run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:[SF_ToThrow,SF_Bullet,SF_StardustSniper],Age:0,Duration:0,Radius:0f}
	execute as @s[nbt={SelectedItem:{tag:{SF_AwakenedStardustSniper:1b}}}] run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:[SF_ToThrow,SF_Bullet,SF_AwakenedStardustSniper],Age:0,Duration:0,Radius:0f}
	execute as @s[nbt={SelectedItem:{tag:{SF_UltimateSniper:1b}}}] run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:[SF_ToThrow,SF_Bullet,SF_UltimateSniper],Age:0,Duration:0,Radius:0f}
...
#Check bullet and add damage
	...
	execute as @s[nbt={Inventory:[{tag:{SF_StardustFragment:1b}}]}] run scoreboard players set Bullet SF_Data 3
	execute as @s[nbt={Inventory:[{tag:{SF_AwakenedStardust:1b}}]}] run scoreboard players set Bullet SF_Data 4
	execute as @s[nbt={Inventory:[{tag:{SF_UltimateBullet:1b}}]}] run scoreboard players set Bullet SF_Data 5
...
execute if score Bullet SF_Data matches 1.. as @s[nbt={SelectedItem:{tag:{SF_StardustSniper:1b}}}] run playsound stardust:sniper_shot_1 ambient @a[distance=..20] ~ ~ ~ 0.5
execute if score Bullet SF_Data matches 1.. as @s[nbt={SelectedItem:{tag:{SF_AwakenedStardustSniper:1b}}}] run playsound stardust:sniper_shot_2 ambient @a[distance=..20] ~ ~ ~ 0.5
execute if score Bullet SF_Data matches 1.. as @s[nbt={SelectedItem:{tag:{SF_UltimateSniper:1b}}}] run playsound stardust:sniper_shot_3 ambient @a[distance=..20] ~ ~ ~ 0.5
