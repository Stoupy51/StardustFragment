...
#Check what Sniper is it and set Base Damage
    execute if entity @s[nbt={SelectedItem:{tag:{SF_StardustSniper:1s}}}] run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:[SF_ToThrow,SF_Bullet,SF_StardustSniper],Age:0,Duration:0,Radius:0f}
    execute if entity @s[nbt={SelectedItem:{tag:{SF_AwakenedStardustSniper:1s}}}] run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:[SF_ToThrow,SF_Bullet,SF_AwakenedStardustSniper],Age:0,Duration:0,Radius:0f}
    execute if entity @s[nbt={SelectedItem:{tag:{SF_UltimateSniper:1s}}}] run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:[SF_ToThrow,SF_Bullet,SF_UltimateSniper],Age:0,Duration:0,Radius:0f}
...
#Check bullet and add damage
    ...
    execute if entity @s[nbt={Inventory:[{tag:{SF_StardustFragment:1s}}]}] run scoreboard players set Bullet SF_Data 3
    execute if entity @s[nbt={Inventory:[{tag:{SF_AwakenedStardust:1s}}]}] run scoreboard players set Bullet SF_Data 4
    execute if entity @s[nbt={Inventory:[{tag:{SF_UltimateBullet:1s}}]}] run scoreboard players set Bullet SF_Data 5
