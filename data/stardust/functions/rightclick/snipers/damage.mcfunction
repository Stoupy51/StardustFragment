...
execute if entity @s[type=ender_dragon] run summon minecraft:creeper ~ ~2 ~ {Fuse:0,ignited:1b,ExplosionRadius:2b,Tags:["StardustFragment_Shooted"]}
execute if entity @s[type=wither] run summon minecraft:creeper ~ ~2 ~ {Fuse:0,ignited:1b,ExplosionRadius:2b,Tags:["StardustFragment_Shooted"]}
