...
execute unless score #absorption stardust.data matches 1.. run function stardust:rightclick/snipers/health
execute if score #absorption stardust.data matches 1.. run function stardust:rightclick/snipers/absorption
