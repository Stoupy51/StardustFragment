...
execute if entity @s[type=minecraft:ender_dragon] run summon minecraft:creeper ~ ~2 ~ {Fuse:0,ignited:1b,ExplosionRadius:2b,Tags:["SF_Shooted"]}
execute if entity @s[type=minecraft:wither] run summon minecraft:creeper ~ ~2 ~ {Fuse:0,ignited:1b,ExplosionRadius:2b,Tags:["SF_Shooted"]}
