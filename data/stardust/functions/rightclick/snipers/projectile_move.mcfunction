...
tp @s ^ ^ ^0.5
execute as @e[dx=0,dy=3,dz=0,distance=..3,tag=!SF_Shooter,tag=!SF_Shooted,type=!minecraft:item,type=!#energy:valid_block_entities] at @s run function stardust:rightclick/snipers/damage
