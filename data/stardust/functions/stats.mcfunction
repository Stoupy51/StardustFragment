...
execute store result score #temp stardust.data if entity @e[tag=stardust.destroyer]
tellraw @s ["",{"text":"Custom blocks loaded: ","color":"gray"},{"score":{"name":"#temp","objective":"stardust.data"},"color":"gold"}]

execute store result score #temp stardust.data if entity @e[tag=stardust.seed]
tellraw @s ["",{"text":"Custom seeds: ","color":"gray"},{"score":{"name":"#temp","objective":"stardust.data"},"color":"gold"}]

execute store result score #temp stardust.data if entity @e[tag=stardust.ore]
