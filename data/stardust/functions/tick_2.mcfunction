...
#Others
	...
	execute if score #stardust_pillar stardust.data matches 1.. as @e[type=armor_stand,tag=stardust.pillar_tick] at @s run function stardust:boss/stardust_pillar/tick_2
