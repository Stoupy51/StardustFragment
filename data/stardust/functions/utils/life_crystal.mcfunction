...
execute unless score LifeCrystalDisabled stardust.config matches 1 run tellraw @s[scores={stardust.life_crystals=21..}] [{"text":"You have collected enough life crystals to use them!","color":"green"}]
