...
execute if entity @s[tag=stardust.awakened_stardust_furnace_generator] run function stardust:visual/furnace_generator/awakened
...
execute if entity @s[tag=stardust.awakened_stardust_solar_panel] unless score @s energy.storage matches 1600.. run function stardust:work/solar_panel/awakened
