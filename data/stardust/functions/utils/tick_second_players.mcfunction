...
#Inventory conditions
	...
	execute if data storage stardust:main Inventory[{Slot:103b,tag:{stardust:{solarium_helmet:1b}}}] if data storage stardust:main Inventory[{Slot:102b,tag:{stardust:{solarium_chestplate:1b}}}] if data storage stardust:main Inventory[{Slot:101b,tag:{stardust:{solarium_leggings:1b}}}] if data storage stardust:main Inventory[{Slot:100b,tag:{stardust:{solarium_boots:1b}}}] run effect give @s fire_resistance 2 0 true
