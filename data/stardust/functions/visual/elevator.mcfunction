execute if score @s energy.storage matches 20.. positioned ~ ~1 ~ as @a[distance=..1,dx=0,dz=0] unless score @s StardustFragment_X matches ..-1 run function stardust:work/elevator/all
