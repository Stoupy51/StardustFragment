...
#Update gui depends on BurnTime
	...
	execute if score #success simplenergy.data matches 1 run data modify entity @s item.tag.CustomModelData set value 2013325
	execute if score #success simplenergy.data matches 0 run data modify entity @s item.tag.CustomModelData set value 2013326
