...
#Update gui depends on BurnTime
    ...
    execute unless block ~ ~ ~ minecraft:furnace{BurnTime:0s} run data modify block ~ ~ ~ Items[1] set value {Slot:1b,id:"minecraft:cobblestone",Count:1b,tag:{CustomModelData:2013102,SE_CustomTextureItem:1b,display:{Name:'[{"text":""}]'}}}
