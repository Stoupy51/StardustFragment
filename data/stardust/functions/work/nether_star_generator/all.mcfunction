...
execute if score #temp stardust.data matches 1.. run playsound stardust:nether_star_generator block @a[distance=2..12,tag=!stardust.ps.nether_star_generator] ~ ~ ~ 0.04
execute if score #temp stardust.data matches 1.. run playsound stardust:nether_star_generator block @a[distance=..2,tag=!stardust.ps.nether_star_generator] ~ ~ ~ 0.20
