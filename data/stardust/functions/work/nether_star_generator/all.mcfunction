...
execute if score BurnTime SF_Data matches 1.. run scoreboard players add @s EF_kJ 1500
execute if score BurnTime SF_Data matches 1.. run playsound stardust:nether_star_generator block @a[distance=..10] ~ ~ ~ 0.25
