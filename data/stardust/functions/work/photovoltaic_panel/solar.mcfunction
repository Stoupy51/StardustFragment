...
execute if score Temp SF_Data matches 1 if score DayTime SF_Data matches 13500..22500 run scoreboard players add @s EF_kJ 8
execute if score Temp SF_Data matches 1 unless score DayTime SF_Data matches 13500..22500 run scoreboard players add @s EF_kJ 32
