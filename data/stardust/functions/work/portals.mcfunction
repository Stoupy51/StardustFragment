...
execute as @s[tag=SF_InfiniteEnergy] run scoreboard players operation @s EF_kJ = @s EF_kW
execute if score @s EF_kJ >= @s EF_kW run tag @s add SF_WorkingPortal
execute as @s[tag=SF_WorkingPortal] run scoreboard players operation @s EF_kJ -= @s EF_kW
