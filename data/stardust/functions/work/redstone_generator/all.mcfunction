...
execute if score #temp stardust.data matches 1.. run playsound stardust:redstone_generator block @a[distance=..10,tag=!stardust.ps.redstone_generator] ~ ~ ~ 0.25
execute if score #temp stardust.data matches 1.. run tag @a[distance=..10,tag=!stardust.ps.redstone_generator] add stardust.ps.redstone_generator
