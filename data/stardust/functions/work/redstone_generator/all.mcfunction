...
execute if score #temp stardust.data matches 1.. run playsound stardust:redstone_generator block @a[distance=4..12,tag=!stardust.ps.redstone_generator] ~ ~ ~ 0.04
execute if score #temp stardust.data matches 1.. run playsound stardust:redstone_generator block @a[distance=..4,tag=!stardust.ps.redstone_generator] ~ ~ ~ 0.20
