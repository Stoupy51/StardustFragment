...
execute if score #success simplenergy.data matches 0 run scoreboard players add @s energy.storage 32
execute if score #success simplenergy.data matches 1 run scoreboard players add @s energy.storage 8
